package com.academy.automation.kdt;

import com.academy.automation.kdt.engine.*;
...
public class BaseKDTTest {
    protected static final Logger LOG = LogManager.getLogger(com.academy.automation.kdt.BaseKDTTest.class);
